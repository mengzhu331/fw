...
const (
	...
	EC_ILLEGAL_LOCAL_STATE   int = EMC_INTERACTION_ERROR | EMC_STATE_INVALID | 3

	EC_NULL_PARAMETERS        int = EMC_INTERACTION_ERROR | EMC_ILLEGAL_PARAMETTER | 1
	...
	EC_INVALID_GAME_THIS      int = EMC_INTERNAL_ERROR | EMC_ILLEGAL_PARAMETTER | 4
