...
const (
	...
	EC_UNKNOWN_PLAYER_NAME       int = EMC_INTERACTION_ERROR | EMC_ILLEGAL_PARAMETTER | 3

	EC_USE_FULL_AC       int = EMC_INTERACTION_ERROR | EMC_STATE_INVALID | 1
	EC_USE_AC_NOT_AFFORD int = EMC_INTERACTION_ERROR | EMC_STATE_INVALID | 2
